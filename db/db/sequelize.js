...
function defineModels(sequelize) {
    ...
    QuoteSource.belongsToMany(QuoteCategory, { through: 'QuoteSourceQuoteCategories', timestamps: false });
    QuoteCategory.belongsToMany(QuoteSource, { through: 'QuoteSourceQuoteCategories', timestamps: false });
    ...
    User.belongsTo(Role);
    Role.hasMany(User);
    Mood.belongsToMany(User, { through: 'UserMoods', timestamps: true, createdAt: 'date', updatedAt: false });   // <-- modifier humeur de la journée ?
    User.belongsToMany(Mood, { through: 'UserMoods', timestamps: true, createdAt: 'date', updatedAt: false });
    QuoteSource.belongsTo(User);
    User.hasMany(QuoteSource);
    QuoteList.belongsToMany(QuoteView, { through: 'QuoteListQuoteViews', timestamps: false });
    QuoteView.belongsToMany(QuoteList, { through: 'QuoteListQuoteViews', timestamps: false });
    QuoteList.belongsToMany(User, { through: 'UserQuoteLists', timestamps: false });
    User.belongsToMany(QuoteList, { through: 'UserQuoteLists', timestamps: false });
